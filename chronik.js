...
TB.chronik = (function () {
  ...
  function eintraege() {
    return [
      ["23.9.2026", "Etappe 7: Tabellen",
       "Tabellen aus KISIM kommen jetzt als Tabellen an — mit verbundenen Zellen, seitengenauen Linien, Spaltenbreiten, Hintergründen und Zentrierung. Die Duplex-Vorlage mit ihrer hohen Legendenzelle war der Prüfstein. Dazu Werkzeuge für Zeilen und Spalten, Spaltenbreite in Stufen, Ausrichtung und Hintergrund je Zelle, Zellen verbinden und lösen, und ein Knopf für ganz neue Tabellen. Die Häkchen stehen einheitlich als ✓, das Durchmesserzeichen als ø. Neu lässt sich ausserdem jeder Baustein kopieren: der Inhalt wird übernommen, Titel und Kürzel müssen neu vergeben werden. Das Windows-Skript holt den Nachschub nun alle dreissig Sekunden selbst — vorher fragt es in einem winzigen Ruf, ob sich überhaupt etwas geändert hat.",
       "Zwei Fehler versteckten sich hinter derselben Annahme: dass die App wisse, wie eine Tabelle auszusehen hat. Sie wusste es nur im eigenen Fenster — in Word, Axenita und der Erweiterung stand dieselbe Tabelle nackt und zusammengeschrumpft da, weil sie ihre Linien und ihre Breite vom Stilblatt der App borgte statt sie selbst mitzubringen. Und ein Zeichen in KISIMs Symbolschrift hielt die App pauschal für ein Häkchen — in Wahrheit war es das Durchmesserzeichen im Gefässbefund."],
